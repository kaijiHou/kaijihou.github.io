export const site = {
  person: {
    ...
    about:
      '硕士期间深耕计算机技术，本科阶段排名专业前5%，具备系统的计算机科学与技术理论知识。在实习与项目中深入参与大模型微调、部署与应用，熟悉从数据构建到模型落地的全流程；在无人机定位、图像超分辨率等计算机视觉任务中提出创新模块并实现性能显著提升。以第一作者在SCI等期刊发表多篇论文，参与国家级创新项目并主导技术方案设计。',
    strengths: [
      {
        title: '扎实的技术根基',
        desc: '硕士期间发表 3 篇 SCI/CCF 论文，深度学习比赛全国前10，获校优秀毕业论文。本科阶段排名专业前5%，具备系统的计算机科学与技术理论知识，获得多项奖学金及荣誉奖项。',
        icon: '🎓',
      },
      {
        title: '大模型与CV项目经验',
